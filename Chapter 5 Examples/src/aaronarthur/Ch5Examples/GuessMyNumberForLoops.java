...
public class GuessMyNumberForLoops {
	...
	public static void main(String[] args) {
		...
		int choice = 0;
		for (choice = 0 ; choice != 5 ; choice = 0) {
		...
		if (choice == 1) {
			...
			// Start betting
			int betCondition = 0;
			for (betCondition = 0 ; betCondition == 0 ; betCondition = 1) {
			...
			int optionsChoice = 0;
			for (optionsChoice = 0 ; optionsChoice != 4 ; optionsChoice = 0) {
				System.out.print("\nOptions:\n"
